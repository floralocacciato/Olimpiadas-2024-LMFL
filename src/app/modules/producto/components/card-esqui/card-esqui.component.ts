...
@Component({
  selector: 'app-card-esqui',
  templateUrl: './card-esqui.component.html',
  styleUrls: ['./card-esqui.component.css']
})
export class CardEsquiComponent {
  // Colección de todos los productos
  coleccionProductos: Producto[] = [];

  // Colección de sólo productos de categoría "Juguetes"
  coleccionEsqui: Producto[] = [];
  ...
  mostrarProductoEsquies() {
    ...
    this.coleccionProductos.forEach(producto => {
      ...
      if (producto.categoria === "esqui") {
        // .push: sube o agrega un item a una colección
        this.coleccionEsqui.push(producto);
      }
    })
  }
